...
class PolygonTest {
	...
	static boolean onSegment(Point p, Point q, Point r) {
		...
		return false;
	}//End of onSegment method

	/* To find direction of ordered triplet (p, q, r).  The function returns following values
	...
	static boolean isInside(Point polygon[], int n, Point p) {
		...
		do {
			...
			if (isIntersect(polygon[i], polygon[next], p, extreme)) {
				...
				// segment 'i-next', then check if it lies on segment. If it lies, return true,
				// otherwise false
